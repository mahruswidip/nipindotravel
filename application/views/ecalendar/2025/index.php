                ...
                <div class="row align-items-center">
                            ...
                            <ul class="list-unstyled social-icons dark">
                                <li>
                                    <a href="javascript:void(0)" id="prevBtn">
                                        <i class="fa-solid fa-angle-left" style="font-size: 2rem; color: #000;"></i>
                                        <
                                            </a>
                                </li>
                            </ul>
                    ...
                    <div class="col text-center">
                        <a href="<?php echo base_url('') ?>" class="logo m-0">
                            <img style="height: 2.8rem;" src="<?php echo base_url('assets/img/logonip.png') ?>" alt="">
                        </a>
                    </div>
                            ...
                            <ul class="list-unstyled social-icons dark">
                                <li>
                                    <a href="javascript:void(0)" id="nextBtn">
                                        <i class="fa-solid fa-angle-right" style="font-size: 2rem; color: #000;"></i>>
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="container mt-2">
                <div class="row wrapper-social">
                    <div class="col flex flex-row items-center justify-center cursor-pointer w-text-long text-center">
                        <a href="https://www.instagram.com/nipindotourandtravel/">
                    ...
                    <div class="col flex flex-row items-center justify-center cursor-pointer w-text-long text-center">
                        <a href="https://www.facebook.com/nipindotourandtravel">
                            <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    ...
                    <div class="col flex flex-row items-center justify-center cursor-pointer w-text-long text-center">
                        <a href="https://www.tiktok.com/@nipindotravel">
                ...
                <div class="row wrapper-social mt-2">
                    <div class="col flex flex-row items-center justify-center cursor-pointer w-text-long text-center">
                        <a href="<?php echo base_url() ?>">
                            ...
                            <p class="text-dark" style="font-size: small;">www.nipindotravel.com</p>
                        </a>
                    </div>
                </div>
            </div>
